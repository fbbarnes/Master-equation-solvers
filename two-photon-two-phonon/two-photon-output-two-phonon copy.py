...
flux_11_eta_0_h_1 = np.load('flux_11_eta_0_h_1.npy')
flux_11_eta_01_h_1 = np.load('flux_11_eta_01_h_1.npy')
flux_11_eta_05_h_1 = np.load('flux_11_eta_05_h_1.npy')
flux_11_eta_1_h_1 = np.load('flux_11_eta_1_h_1.npy')
flux_11_eta_15_h_1 = np.load('flux_11_eta_1-5_h_1.npy')
flux_11_eta_25_h_1 = np.load('flux_11_eta_2-5_h_1.npy')
flux_11_eta_5_h_1 = np.load('flux_11_eta_5_h_1.npy')
flux_11_eta_10_h_1 = np.load('flux_11_eta_10_h_1.npy')
flux_11_eta_100_h_1 = np.load('flux_11_eta_100_h_1.npy')
...
super_color='purple'
l_width =1
ax.plot(trange[:-1], flux_11_eta_0_h_1, linewidth=l_width,   label=r'$\eta=0$')
ax.plot(trange[:-1], flux_11_eta_05_h_1, linewidth=l_width,   label=r'$\eta=0.5$')
ax.plot(trange[:-1], flux_11_eta_1_h_1, linewidth=l_width,   label=r'$\eta=1$')
ax.plot(trange[:-1], flux_11_eta_15_h_1, linewidth=l_width,   label=r'$\eta=1.5$')
ax.plot(trange[:-1], flux_11_eta_25_h_1, linewidth=l_width,   label=r'$\eta=2.5$')
ax.plot(trange[:-1], flux_11_eta_100_h_1, linewidth=l_width,   label=r'$\eta=100$')
...
ax.legend(handles, labels, frameon=False,  fontsize='small') 
#Info plot
#ax[1].axis('off')
